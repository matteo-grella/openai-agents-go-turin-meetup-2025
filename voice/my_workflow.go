...
var (
	...
	Agent = agents.New("Assistant").
		WithInstructions(handoff_prompt.PromptWithHandoffInstructions(
			"You're a basic assistant. Greet briefly, then respond in the fewest words possible: short, clear, no fillers or explanations, only the essential answer or confirmation.",
		)).
